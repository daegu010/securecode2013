<?php
    ...
    if($mode == "list")
    {
        ...
        <?php
            ...
            while($data)
            {
                ...
                <div class="row">
                    ...
                    <div class="col-9"><a href="main.php?cmd=wysiwyg&mode=view&idx=<?php echo $data["idx"] ?>"><?php echo $data["title"] ?></a></div>
        ...
        <div class="row">
            <div class="col">
                <button type="button" class="btn btn-primary btn-sm" onClick="location.href='main.php?cmd=wysiwyg&mode=write' ">글쓰기</button>
            </div>
        </div>
    ...
    if($mode == "write")
    {
        ...
        <div class="row">
            <div class="col">
                <div id="editor" contenteditable="true" onKeyUp=setHtml() onChange=setHtml()>aaa</div>
            </div>
        </div>
        <div class="row">
            <div class="col">
